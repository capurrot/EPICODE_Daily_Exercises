...
while(m < starWarsCharacters.length) {
  crewMass += starWarsCharacters[m].mass;
  m++
}
...
for (let i=0; i < charactersNames.length; i++) {
  if(charactersNames[i] === femaleCharacters[0] || charactersNames[i] === femaleCharacters[1] ){
      charactersNames.splice(charactersNames[i], 1);
}
}
console.log(charactersNames.length);
/* --EXTRA-- ESERCIZIO 10
...
console.log(r);
console.log("Nome personaggio: " + starWarsCharacters[r].name + "; Massa: " + starWarsCharacters[r].mass + "; Altezza:" + starWarsCharacters[r].height  
            + "; Colore dei capelli: " + starWarsCharacters[r].hair_color + "; Colore della pelle: " + starWarsCharacters[r].skin_color         
            + "; Anno di nascita: " + starWarsCharacters[r].birth_year + "; Genere: " + starWarsCharacters[r].gender + ""
          );